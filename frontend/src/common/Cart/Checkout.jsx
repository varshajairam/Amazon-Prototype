    ...
    <React.Fragment>
            <div className="ui container mt-5">
              <h2 class="ui center aligned header">Review Order</h2>
              {
                                    ...
                                    <div className="ui relaxed divided items">
                                        <div className="item">
                                            ...
                                            <div className="content product-details">
                                                ...
                                                {JSON.parse(currProduct.isGift) && <div className="ui checkbox">
                                                    <input type="checkbox" name="gift" checked={JSON.parse(currProduct.isGift)} />
                                                ...
                                                {currProduct.product.offers.find(offer => offer.type == 'percentage') && <div className="ui right floated green header">
                                                    Applied a discount of {currProduct.product.offers.find(offer => offer.type == 'percentage').value}%
                                                </div>}
                                            </div>
                                        </div>
                                    </div>
                ...
                <h3 className="ui right aligned header">Delivery Charges: ${props.cart.products[0].deliveryCharge}</h3>
                <h3 className="ui right aligned header">Total Cost: ${props.cart.products[0].totalCost}</h3>
                ...
                <div className="ui primary button right floated mt-5" onClick = {() => props.placeOrder({products, cost: props.cart.products[0].totalCost, customer: props.cart.products[0].customer, sellers, shippingAddress: address, billingAddress: address, card})}>
                    Place Order
                </div>
            </div>
    </React.Fragment>
