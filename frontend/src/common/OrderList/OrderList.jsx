      ...
      <div className="orders-wrapper ui container">
        ...
        <div className="orders">
          <div className="ui secondary menu mt-5">
            {
              orderTabs.map((tab, i) => <div className={`order-tab onHover flex-center${activeTab === i ? ' active' : ''}`} key={tab.title} onClick={() => setActiveTab(i)} onKeyDown={() => setActiveTab(i)} role="button" tabIndex="0">{tab.title}</div>)
            }
          </div>
